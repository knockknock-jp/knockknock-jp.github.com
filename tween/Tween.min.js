(function(){window.knockknock||(window.knockknock={});window.knockknock.jp||(window.knockknock.jp={});window.knockknock.jp.Tween=function(a){function c(){clearInterval(b)}var b,d,e;return{play:function(f,g){c();var l=g.duration||null,p=g.easing||null,m=g.play||null,k=g.update||null,n=g.complete||null;e=[];for(var h in f)e.push({targetProperty:h,firstValue:a[h],lastValue:f[h]});g&&m&&m({target:a});if(g&&l&&0<l){p||(p=window.Easing.linear);d=0;var q=this;b=setInterval(function(){for(var b=e.length,
